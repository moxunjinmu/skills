...
每次评估自动追加到 `memory/evolution-log.jsonl`，格式：

```jsonl
{"type":"evaluation","timestamp":"2026-03-26T16:30:00+08:00","task_id":"MO-20260326-S001","dimensions":{"accuracy":8.0,"efficiency":6.0,"safety":9.0,"completeness":5.0,"proactiveness":7.0},"overall":7.0,"feedback":"neutral","weaknesses":["完整性（5.0）","效率（6.0）"],"evolution_suggestion":"完整性和效率，建议接任务后先列清单对标需求再执行"}
```
